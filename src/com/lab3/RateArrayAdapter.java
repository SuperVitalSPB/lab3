...
//            holder.txtName =    (TextView) rowView.findViewById(R.id.txtName);            
        ...
        holder.txtCode.setText(    (CharSequence)    rates.get(position).ValCode);
        holder.txtRate.setText(    (CharSequence)    rates.get(position).ValRate);
        holder.txtNominal.setText( (CharSequence)    rates.get(position).ValNominal);
